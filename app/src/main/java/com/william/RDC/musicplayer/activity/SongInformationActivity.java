...
import com.william.RDC.musicplayer.view.PlayingView;
...
public class SongInformationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle saveInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {//toolbar回退键
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SongInformationActivity.this, DisplayActivity.class);
        ...
        //更新专辑图片
        playingView = findViewById(R.id.gramophone_view);
        ...
        if(myLoveSongs == null)
            myLoveSongs = databaseOperation.loadMyLoveSongs();//从数据库加载我喜爱的歌曲
        ...
        switch (v.getId()) {
            case R.id.love_song_icon:
                ...
                if(current_song.isLove()){
                    ...
                    databaseOperation.setLove(current_song,"false");//更新数据库
                    myLoveSongs.remove(current_song);//更新我喜爱的歌曲list
                }else{//添加并更改图标
                    love_song_icon.setImageDrawable(getResources().getDrawable(R.drawable.full_love_32));
                    current_song.setLove(true);
                    databaseOperation.setLove(current_song,"true");
    ...
    private void showPopupMenu(View view) {
        ...
        PopupMenu popupMenu = new PopupMenu(SongInformationActivity.this, view);
        // 获取布局文件
    ...
    public void loadHistoryView(){
        ...
        adapter_history = new SongAdapter(SongInformationActivity.this, R.layout.song_list_item, PlayHistory.getSongs());
